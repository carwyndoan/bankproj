...
public class JDialog_AddCCAccount extends javax.swing.JDialog {
    ...
    void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) {
        ...
        // create account service - Thai added
        AccountService service = new AccountServiceImpl();
        Account creditCard = service.createCreditCard(parentframe.ccnumber.trim(), parentframe.clientName.trim(), parentframe.street.trim(), parentframe.city.trim(), parentframe.state.trim(), parentframe.zip.trim(), JTextField_Email.getText().trim());
        if (JRadioButton_Gold.isSelected()) {
			creditCard.setAccountType(AccountType.GOLD);
			creditCard.setCcinterestCalculation(new GoldCreditCard());
		}
        else if (JRadioButton_Silver.isSelected()) {
			creditCard.setAccountType(AccountType.SILVER);
			creditCard.setCcinterestCalculation(new SilverCreditCard());
		} else {
